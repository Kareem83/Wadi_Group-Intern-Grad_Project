...
if (/index\.html$/.test(window.location.pathname) || /\/admin\/?$/.test(window.location.pathname)) {
  (function () {
    ...
    var d = document;
    var STORE_KEY = 'wadi_v1_admin_content';
    ...
    var defaults = {
      hero: {
        eyebrow: 'Est. 1984 · Egypt',
        title: 'To Achieve. To Lead.',
        sub: 'Egypt\'s leading agribusiness — three sectors and ten brands built into one integrated supply chain since 1984.',
        image: ''
      },
      sectorAssets: [
        { id: 1, name: 'Dawagen sector logo', file: '../assets/images/Dawagen-sector.png' },
        { id: 2, name: 'Mazareh sector logo', file: '../assets/images/Mazareh-sector.png' },
        { id: 3, name: "Sina'at sector logo", file: '../assets/images/Sinaat-sector.png' }
      ],
      leaders: [
        { id: 1, name: 'Mr. Musa Freiji', role: 'Founding Shareholder & Director', pill: 'Founder', group: 'Top Leaders', bio: 'A founding figure behind Wadi Group, with a BSc in Agricultural Engineering from the American University of Beirut. His poultry industry experience began in the 1950s.', photo: '../assets/images/musa-freiji.jpg' },
        { id: 2, name: 'Mr. Tony Freiji', role: 'Executive Chairman, Shareholder', pill: 'Shareholder', group: 'Wadi Poultry Group Board of Directors', bio: 'Joined Wadi in 1984 after studying Agricultural Engineering at AUB and Poultry Nutrition at Iowa State University. He has led production, commercial operations and expansion projects.', photo: '../assets/images/tony-freiji.jpg' },
        { id: 3, name: 'Mr. Ramzi P. Nasrallah', role: 'Vice-Chairman & Managing Director, Shareholder', pill: 'Shareholder', group: 'Wadi Poultry Group Board of Directors', bio: 'Responsible for corporate financial direction, audit activity and budget planning. He joined Wadi at the establishment stage.', photo: '../assets/images/ramzi-nasrallah.jpg' },
        { id: 4, name: 'Mrs. Rima Freiji', role: 'Director, Head of Governance Committee, Shareholder', pill: 'Shareholder', group: 'Wadi Poultry Group Board of Directors', bio: 'Leads governance and institutional development initiatives. She joined Wadi in 2008 and later became Chief Development Officer.', photo: '../assets/images/rima-freiji.jpg' }
      ],
      media: [
    ...
    function renderHero() {
      ...
      prev.style.backgroundImage = data.hero.image
        ? 'url(' + data.hero.image + ')'
        : 'linear-gradient(135deg,#3a4c5f,#2a3847)';
    ...
    function renderMediaTable() {
      ...
      body.innerHTML = rows.map(function (m) {
        var icon = m.type === 'video' ? '▶' : (m.category === 'Events' ? 'Ev' : 'N');
        return '' +
          '<tr data-id="' + m.id + '">' +
